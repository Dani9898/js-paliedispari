...
// Creare una funzione per capire se la parola inserita è palindroma. => function(parola) charAt(i) per selezionare un carattere di un parola e poi confrontare quel carattere  il primo con l'ultimo, il secondo con il penutilmo etc... Se è pari tutto ok se è dispari bisogna che non conti il carattere in mezzo. quindi fare un controllo finche non arriva alla metà quidi => math.Floor sulla lunghezza della parola. Se nel confronto troviamo una disuguaglianza allora variabile booleana = false, se no rimane vera. Ritornara la variabile.
